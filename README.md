# Deckadence
<p align="center">
  <img src="https://github.com/Tetrapak0/Deckadence/blob/main/icon.png?raw=true" alt="Icon"/>
</p>
...
- [Build](#build)
  ...
  - [4. Build](#4-build)
## Acquisition:
- [Prebuilt binaries](https://github.com/Tetrapak0/NexusShell/releases) ([Install dependencies first](#2-install-dependencies))
